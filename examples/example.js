...
// with object regex
const twMatches = SocialExtraction.extractMatchesByRegex(
  PlatformsRegex.REGEX[SocialsRegex.Platforms.PLATFORM_TWITTER],
  text
)
console.log('tw matches:', twMatches)

const linkedinMatches = SocialExtraction.extractMatchesByRegex(
  PlatformsRegex.REGEX[SocialsRegex.Platforms.PLATFORM_LINKEDIN].profile,
  text
)
